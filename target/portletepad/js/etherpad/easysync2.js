...
Changeset.makeSplice = function(oldFullText, spliceStart, numRemoved, newText, optNewTextAPairs, pool)
{
  ...
  console.log("easysync2: oldLen: "+ oldLen);
//  ORIGINALY
...
//	MODIFIED
  ...
  console.log("easysync2: spliceStart: "+ spliceStart);
  if (numRemoved > 1 && numRemoved > oldFullText.length - spliceStart - 1)
  {
    numRemoved = oldFullText.length - spliceStart - 1;
  }
  console.log("easysync2: numRemoved: "+ numRemoved);
  var oldText = oldFullText.substring(spliceStart, spliceStart + numRemoved);
  console.log("easysync2: oldText: "+ oldText);
  var newLen = oldLen + newText.length - oldText.length;
  console.log("easysync2: newLen: "+ newLen);
